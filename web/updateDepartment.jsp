<%-- 
    ...
    Created on : Dec 16, 2019, 8:57:44 PM
    Author     : HP
--%>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="overview-wrap">
                            <h2 class="title-1">Edit Department Data</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <form action="departmentServlet?action=update" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="idDepartment" name="idDepartment" value="<%= request.getAttribute("idDepartment") %>" placeholder="Enter Department Id" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="city" class="form-control" required>
                                            <option value="<%= request.getAttribute("city") %>">
                                                <%= request.getAttribute("city") %> - <%= request.getAttribute("siti") %>
                                            </option>
                                            <option value="<%= request.getAttribute("city") %>">
                                                ----- Choose City -----
                                            </option>
